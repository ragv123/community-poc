...
(function($CQ, _, Backbone, SCF) {
    ...
    SCF.registerComponent('journal-poc/components/hbs/comment', SCF.BlogPost, SCF.BlogPostView);
    SCF.registerComponent('journal-poc/components/hbs/entry_topic', SCF.BlogTopic, SCF.BlogTopicView);
    SCF.registerComponent('journal-poc/components/hbs/journal', SCF.Journal, SCF.JournalView);
})($CQ, _, Backbone, SCF);
