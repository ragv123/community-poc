...
@Endpoint(name = "JournalCommentCreateOperation", resourceType = "social/journal/components/hbs/journal", description = "Create a new journal entry or comment.", example = "curl -X POST -H \"Accept:application/json\" -d \"subject=newEntry&message=test&id=nobot&:operation=social:createJournal\" -uaparker@geometrixx.info:aparkerhttp:hostname:port/path/to/journal.social.json")
@Parameters({
