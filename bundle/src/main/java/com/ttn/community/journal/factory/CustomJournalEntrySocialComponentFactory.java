...
import com.ttn.community.journal.poc.JournalEntrySocialComponent;

@Component(name = "Blog Social journal Entry Component Factory", immediate = true)
@Service
public class CustomJournalEntrySocialComponentFactory extends AbstractSocialComponentFactory
		implements SocialComponentFactory {

	private static final Logger LOG = LoggerFactory.getLogger(CustomJournalEntrySocialComponentFactory.class);
